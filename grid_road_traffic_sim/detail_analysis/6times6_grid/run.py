...
# Road Configuration
num_grid = (6,6)                                                                # num. of grids (rows, cols)
...
################  turning probability setting  ###################
center_ids = [14, 15, 20, 21]  # 6x6 → 2x2
turn_prob = {}
for sid in center_ids:
    turn_prob[sid] = {
        'up'   : {'straight':0.7, 'right':0.15, 'left':0.15},
        'down' : {'straight':0.7, 'right':0.15, 'left':0.15},
        'right': {'straight':0.65,'right':0.2 , 'left':0.15},
        'left' : {'straight':0.65,'right':0.15, 'left':0.2 },
    }
